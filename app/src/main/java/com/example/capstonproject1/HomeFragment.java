...
public class HomeFragment extends Fragment implements OnMapReadyCallback ,  ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        int hasFineLocationPermission = ContextCompat.checkSelfPermission(mainScreenActivity,
                Manifest.permission.ACCESS_FINE_LOCATION);
        int hasCoarseLocationPermission = ContextCompat.checkSelfPermission(mainScreenActivity,
        ...
        if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED &&
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(mainScreenActivity, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( mainScreenActivity, REQUIRED_PERMISSIONS,
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        //지오코더... GPS를 주소로 변환
        MainScreenActivity mainScreenActivity = new MainScreenActivity();
        Geocoder geocoder = new Geocoder(mainScreenActivity, Locale.getDefault());
        ...
        try {
            ...
            //네트워크 문제
            Toast.makeText(mainScreenActivity, "지오코더 서비스 사용불가", Toast.LENGTH_LONG).show();
            return "지오코더 서비스 사용불가";
        } catch (IllegalArgumentException illegalArgumentException) {
            Toast.makeText(mainScreenActivity, "잘못된 GPS 좌표", Toast.LENGTH_LONG).show();
            return "잘못된 GPS 좌표";
        ...
        if (addresses == null || addresses.size() == 0) {
            Toast.makeText(mainScreenActivity, "주소 미발견", Toast.LENGTH_LONG).show();
            return "주소 미발견";
    ...
    public void onRequestPermissionsResult(int permsRequestCode,
        ...
        if (permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            if (check_result) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(mainScreenActivity, REQUIRED_PERMISSIONS[0])
                        || ActivityCompat.shouldShowRequestPermissionRationale(mainScreenActivity, REQUIRED_PERMISSIONS[1])) {
